...
export const FORTUNE_TYPES = [
  {
    ...
    lobbyTitle: '出门渡劫',
    lobbySubtitle: '拍鞋/防盗门 · 测通勤运势（照片可选）',
    placeholder: '输入吐槽或拍照…',
    hint: '可拍鞋、外套、天气，也可纯文字',
  ...
  },
  {
    ...
    lobbyTitle: '搬砖续命',
    lobbySubtitle: '拍工位/键盘 · 算摸鱼指数（照片可选）',
    placeholder: '输入吐槽或拍照…',
    hint: '可拍工位、咖啡，也可纯文字',
  ...
  },
  {
    ...
    lobbyTitle: '深夜修仙',
    lobbySubtitle: '拍床头灯/天花板 · 解 emo 煞气（照片可选）',
    placeholder: '输入吐槽或拍照…',
    hint: '可拍床头灯、天花板，也可纯文字',
  ...
  },
  {
    ...
    cardTitle: '随时随地拍一卦',
    title: '万能盲盒提问',
    description: '碎碎念或拍照，任选其一',
    missionText: '随手问一句或拍一张，盲盒卦象随机掉落',
    lobbyTitle: '随手乱拍',
    lobbySubtitle: '万物皆可卦 · 文字或照片均可',
    placeholder: '输入碎碎念，或拍照…',
    hint: '可纯文字提问，也可拍照辅助',
